...
$sql = mysql_query("SELECT * FROM OFFICIAL"); 
$i = 0;
// Establish the output variable
$dyn_table = '<table border="5" cellpadding="5">';

	$dyn_table .= '<tr><th>OFFICIAL_ID</th>';
	$dyn_table .= '<th>OFFICIAL_NAME</th>';
...
while($row = mysql_fetch_array($sql)){ 
    ...
    $id = $row["id"];
    $member1_name = $row["OFFICIAL_ID"];
    $member2_name = $row["OFFICIAL_NAME"];
...
?>
<html>
<body style="width:100%;height:100%;background-image:url('olympic_o.jpg');background-attachment:fixed;background-repeat:no-repeat;background-size:cover;opacity:0.9;">
<div >
